export const jaJP = {
  translation: {
    ...
    "general/update": "更新",
    "general/close": "閉じる",
    "general/open-menu": "メニューを開く",
    "general/expand": "展開する",
    "general/collapse": "折りたたむ",
    "general/Note": "ノート",
    "general/notes": "ノート",
    "general/Settings": "設定",
    ...
    "general/note-menu": "ノートメニュー",
    "general/sort-notes": "ノートを並べ替える",
    "general/table-of-contents": "目次",
    "general/change-note-icon": "ノートのアイコンを変更する",
    "general/Audio": "音声",
    "general/Video": "映像",
    ...
    "widget/crossnote.kanban/edit-card": "カードを編集する",
    "widget/crossnote.kanban/delete-card": "カードを削除する",
