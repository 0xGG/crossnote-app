export const zhCN = {
  translation: {
    ...
    "general/note-menu": "笔记菜单",
    "general/sort-notes": "排序笔记",
    "general/table-of-contents": "目录",
    "general/change-note-icon": "更改笔记图标",
    "general/Audio": "音频",
    "general/Video": "视频",
    ...
    "widget/crossnote.kanban/edit-card": "编辑卡片",
    "widget/crossnote.kanban/delete-card": "删除卡片",
