...
(function (mod){ //[HyperMD] UMD patched!
  ...
  /*plain env*/ mod(null, (this.HyperMD.Theme = this.HyperMD.Theme || {}), );
    ...
    function setTheme(_a) {
        ...
        // Set preview theme
        var previewThemeStyleElementID = "echomd-preview-theme";
        ...
        var codeBlockThemeStyleElementID = "echomd-code-block-theme";
        ...
        // Set editor theme
        var editorThemeStyleElementID = "echomd-editor-theme";
